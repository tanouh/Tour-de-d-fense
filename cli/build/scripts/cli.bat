...
set CLASSPATH=%APP_HOME%\lib\cli.jar;%APP_HOME%\lib\json-20171018.jar


@rem Execute cli
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLI_OPTS%  -classpath "%CLASSPATH%" up.TowerDefense.cli.CLILauncher %*
